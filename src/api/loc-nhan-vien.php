<?php
// 1. Xóa bỏ hoàn toàn tất cả các ký tự trống, khoảng trắng hoặc lệnh HTML nằm trước thẻ <?php (nếu có)

// 2. Xóa sạch mọi bộ đệm đầu ra trước đó để ngăn chặn triệt để lỗi "headers already sent"
if (ob_get_length()) {
    ob_clean();
}
