...
try {
    $stmtList = $pdo->prepare("
        SELECT 
            ...
            hd.TongTienThuoc,
            hd.TongCong,
            (hd.TongCong - hd.TongTienCLS - hd.TongTienThuoc) AS TongTienKham,
            hd.GiamGia,
            hd.TongThanhToan,
            hd.TrangThai,
            hd.NgayTao
        ...
        JOIN phieukham pk ON pk.MaBenhNhan = bn.MaBN 
    ...
    // Để bạn dễ debug nếu có sai sót tên cột khác
    $errorMsg = $e->getMessage();
    echo "<script>console.error('SQL Error: " . addslashes($errorMsg) . "');</script>";
}
?>
<link rel="stylesheet" href="public/assets/css/BenhNhan/hoa-don.css">
